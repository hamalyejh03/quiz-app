...
-- Run this in MySQL Workbench or command line with safe mode disabled
-- Command: mysql -u root -p --safe-updates=0 quizapp < chemistry_questions_safe.sql

-- Disable safe mode and update quiz title
SET SQL_SAFE_UPDATES = 0;
UPDATE quizzes SET title = 'Chimie' WHERE title = 'Géographie';
